 ...
 * @author typek_pb
 */
@DecrypterPlugin(revision = "$Revision: 12134 $", interfaceVersion = 2, urls = { "http://[\\w\\.]*?surfmovies\\.org/(surf-movies|surf-music|online-surf-movies|bodyboard-movies)/.+html" }, flags = { 0 }, names = { "www.surfmovies.org" })
