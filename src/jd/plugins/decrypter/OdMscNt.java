...
@DecrypterPlugin(revision = "$Revision: 10285 $", interfaceVersion = 2, names = { "odimusic.net" }, urls = { "http://[\\w\\.]*?odimusic\\.net/download/(music/.*?\\.html|engine/go\\.php\\?url=[a-zA-Z0-9% ]+)" }, flags = { 0 })
