...
@DecrypterPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "urlcrypt.com", "xeem.in" }, urls = { "http://[\\w\\.]*?urlcrypt\\.com/open-.*?\\.htm", "http://[\\w\\.]*?xeem\\.in/open-.*?\\.htm" }, flags = { 0, 0 })
