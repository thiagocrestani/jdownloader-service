...
@DecrypterPlugin(revision = "$Revision: 8747 $", interfaceVersion = 2, names = { "wii-reloaded.info" }, urls = { "http://[\\w\\.]*?(protect\\.wii|wii)-reloaded\\.(info|org)(/protect)?/get\\.php\\?i=[a-zA-Z-0-9]+" }, flags = { 0 })
