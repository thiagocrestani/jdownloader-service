...
@DecrypterPlugin(revision = "$Revision: 10231 $", interfaceVersion = 2, names = { "loshare.com" }, urls = { "http://[\\w\\.]*?loshar(e|a)\\.com/folders\\.php\\?fid=([a-zA-Z0-9_-]+\\&s=[0-9]+|[a-zA-Z0-9_-]+)" }, flags = { 0 })
