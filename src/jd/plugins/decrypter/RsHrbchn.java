...
@DecrypterPlugin(revision = "$Revision: 10038 $", interfaceVersion = 2, names = { "rs.hoerbuch.in" }, urls = { "http://rs\\.hoerbuch\\.in/com-[\\w]{11}/.*|http://rs\\.hoerbuch\\.in/de-[\\w]{11}/.*|http://rs\\.hoerbuch\\.in/u[\\w]{6}.html|http://rs\\.hoerbuch\\.in/s[\\w]{10}.html" }, flags = { 0 })
