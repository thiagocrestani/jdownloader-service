...
@DecrypterPlugin(revision = "$Revision: 12968 $", interfaceVersion = 2, names = { "ddl-music.org" }, urls = { "http://(www\\.)?ddl-music\\.org/(download/\\d+/.*?/|download/links/[a-z0-9]+/(mirror/\\d+/)?)" }, flags = { 0 })
