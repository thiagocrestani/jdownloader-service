...
@DecrypterPlugin(revision = "$Revision: 7387 $", interfaceVersion = 2, names = { "ddl-music.org" }, urls = { "http://[\\w\\.]*?ddl-music\\.org/index\\.php\\?site=view_download&cat=.+&id=\\d+|http://[\\w\\.]*?ddl-music\\.org/captcha/ddlm_cr\\d\\.php\\?\\d+\\?\\d+" }, flags = { 0 })
