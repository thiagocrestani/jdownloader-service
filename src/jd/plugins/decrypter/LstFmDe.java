...
@DecrypterPlugin(revision = "$Revision: 10119 $", interfaceVersion = 2, names = { "lastfm.de" }, urls = { "http://([\\w\\.]|cn)*?(lastfm|last)\\.(fm|de|pl|es|fr|it|jp|com\\.br|ru|se|com\\.tr)/(user/[a-zA-Z0-9]+|.+)" }, flags = { 0 })
