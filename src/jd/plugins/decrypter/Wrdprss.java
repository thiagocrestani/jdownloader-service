...
@DecrypterPlugin(revision = "$Revision: 7601 $", interfaceVersion = 2, names = {}, urls = {}, flags = {})
public class Wrdprss extends PluginForDecrypt {
    ...
    public static String[] getAnnotationUrls() {
        ...
        logger.finest("Wrdprss: " + (10 + listType1.length + listType2.length + listType3.length) + " Pattern added!");
