...
@DecrypterPlugin(revision = "$Revision: 12744 $", interfaceVersion = 2, names = { "frozen-roms.in" }, urls = { "http://[\\w\\.]*?frozen-roms\\.in/download/\\d+/(wii|nds|gba|gbc|nes|n64|snes)/.{1}" }, flags = { 0 })
