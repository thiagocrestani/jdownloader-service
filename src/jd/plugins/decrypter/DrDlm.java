...
@DecrypterPlugin(revision = "$Revision: 11679 $", interfaceVersion = 2, names = { "drei.to" }, urls = { "http://[\\w\\.]*?drei\\.to/link/[a-zA-Z0-9]+|http://[\\w\\.]*?drei\\.to/download/start/[0-9]+/|http://[\\w\\.]*?drei\\.to/download/[0-9]+/.+\\.html|http://[\\w\\.]*?drei\\.to/\\?action=entrydetail&entry_id=[0-9]+" }, flags = { 0 })
