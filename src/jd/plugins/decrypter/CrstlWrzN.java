...
@DecrypterPlugin(revision = "$Revision: 7387 $", interfaceVersion = 2, names = { "crystal-warez.in" }, urls = { "http://[\\w\\.]*?crystal-(warez|board)\\.in//?(show_download|protect)/.*?\\.html" }, flags = { 0 })
