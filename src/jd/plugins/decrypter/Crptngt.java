...
@DecrypterPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "crypting.it" }, urls = { "http://[\\w\\.]*?crypting\\.it/(s/[\\w]+|index\\.php\\?p=show(usrfolders)?(&user=.+)?&id=[\\w]+)" }, flags = { 0 })
