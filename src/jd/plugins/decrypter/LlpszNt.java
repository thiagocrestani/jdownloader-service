...
@DecrypterPlugin(revision = "$Revision: 12808 $", interfaceVersion = 2, names = { "klipsiz.net" }, urls = { "http://[\\w\\.]*?klipsiz\\.net/(([a-zA-Z0-9-.]+|[a-z]{1}/[0-9]+)\\.php|mp3-dinle-indir/[0-9]+-[0-9]+/)" }, flags = { 0 })
