...
@DecrypterPlugin(revision = "$Revision: 12745 $", interfaceVersion = 2, names = { "abload.de" }, urls = { "http://[\\w\\.]*?abload\\.de/(gallery\\.php\\?key=[A-Za-z0-9]+|browseGallery\\.php\\?gal=[A-Za-z0-9]+\\&img=.+)" }, flags = { 0 })
