 ...
 * @author typek_pb
 */
@DecrypterPlugin(revision = "$Revision: 11912 $", interfaceVersion = 2, urls = { "http://[\\w\\.]*?avaxhome\\.ws/(ebooks|music|software|video|magazines|games|graphics|misc|hraphile)/.+" }, flags = { 0 }, names = { "avaxhome.ws" })
