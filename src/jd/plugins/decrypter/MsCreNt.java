...
@DecrypterPlugin(revision = "$Revision: 12843 $", interfaceVersion = 2, names = { "musicore.net" }, urls = { "http://[\\w\\.]*?musicore\\.net/(forums/index\\.php\\?/topic/\\d+-|\\?id=.*?\\&url=[a-zA-Z0-9=+/\\-]+|url\\.php\\?id=\\w+\\&url=[A-Za-z0-9/\\+]+)" }, flags = { 0 })
