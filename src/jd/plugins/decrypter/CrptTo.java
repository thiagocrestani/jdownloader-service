...
//by pspzockerscene
@DecrypterPlugin(revision = "$Revision: 12528 $", interfaceVersion = 2, names = { "crypt.to" }, urls = { "http://[\\w\\.]*?(crypt\\.to|mamangu\\.com)/(fid|links),[0-9a-zA-Z]+" }, flags = { PluginWrapper.CNL_2 })
