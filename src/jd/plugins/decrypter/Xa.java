...
@DecrypterPlugin(revision = "$Revision: 12379 $", interfaceVersion = 2, names = { "luxport.eu" }, urls = { "http://[\\w\\.]*?(ex|luxport)\\.(ua|eu|ru)/((view|get|load)/[0-9]+(.+)?|(view/[0-9]+\\?r=[0-9]+|view/[0-9]+\\?r=[0-9,]+))" }, flags = { 0 })
