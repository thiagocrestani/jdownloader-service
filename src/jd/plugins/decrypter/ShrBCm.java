...
//    Copyright (C) 2009  JD-Team jdownloader@freenet.de
//
...
@DecrypterPlugin(revision = "$Revision: 7387 $", interfaceVersion = 2, names = { "sharebee.com" }, urls = { "http://[\\w\\.]*?sharebee\\.com/[\\w]{8}" }, flags = { 0 })
