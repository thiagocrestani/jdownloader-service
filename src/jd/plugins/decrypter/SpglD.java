...
@DecrypterPlugin(revision = "$Revision: 12486 $", interfaceVersion = 2, names = { "spiegel.de" }, urls = { "(http://[\\w\\.]*?spiegel\\.de/video/video-\\d+.html|http://[\\w\\.]*?spiegel\\.de/fotostrecke/fotostrecke-\\d+(-\\d+)?.html)" }, flags = { 0 })
