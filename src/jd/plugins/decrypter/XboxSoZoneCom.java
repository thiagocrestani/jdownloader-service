...
@DecrypterPlugin(revision = "$Revision: 12838 $", interfaceVersion = 2, names = { "xboxisozone.com" }, urls = { "http://[\\w\\.]*?((xboxisozone|dcisozone|gcisozone)\\.com/downloads/\\d+/.*?\\.html|psisozone\\.com/downloads/\\d+/.*?/|romgamer\\.com/roms/.*?/\\d+/)" }, flags = { 0 })
