...
@DecrypterPlugin(revision = "$Revision: 11049 $", interfaceVersion = 2, names = { "uu.canna.to" }, urls = { "http://[uu\\.canna\\.to|85\\.17\\.36\\.224]+/cpuser/links\\.php\\?action=[cp_]*?popup&kat_id=[\\d]+&fileid=[\\d]+" }, flags = { 0 })
