...
@DecrypterPlugin(revision = "$Revision: 10256 $", interfaceVersion = 2, names = { "picasaweb.google.com" }, urls = { "http://[\\w\\.]*?picasaweb\\.google\\.com/.*?/.*?(\\?feat=(featured#[0-9]+|featured#)|#[0-9]+|#)" }, flags = { 0 })
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (Regex.matches(parameter, singlelink)) {
            ...
            for (String piclink : picLinks) {
                br.getPage("http://picasaweb.google.com/" + piclink);
