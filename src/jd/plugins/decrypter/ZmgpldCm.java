...
@DecrypterPlugin(revision = "$Revision: 11221 $", interfaceVersion = 2, names = { "zomgupload.com" }, urls = { "(?!http://[\\w\\.]*?zomgupload\\.com/.+[/0-9a-zA-Z/-]+.html)http://[\\w\\.]*?zomgupload\\.com/.+[/0-9a-zA-Z/-]" }, flags = { 0 })
