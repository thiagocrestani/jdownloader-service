...
@DecrypterPlugin(revision = "$Revision: 12528 $", interfaceVersion = 2, names = {  "realfiles.net", "youfap.com", "linkgalleries.net", "thesefiles.com", "urlpulse.net", "placepictures.com", "viraldatabase.com", "seriousfiles.com", "ubucks.net", "thesegalleries.com", "seriousurls.com", "blahetc.com", "baberepublic.com", "qvvo.com", "linkbucks.com", "linkseer.net", "ubervidz.com", "uberpicz.com", "zxxo.net", "ugalleries.net", "picturesetc.net" }, urls = { "http://[\\w\\.]*?realfiles\\.net(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?youfap\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?linkgalleries\\.net(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?thesefiles\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?urlpulse\\.net(/link/[0-9a-fA-F]+(/\\d+)?)?", "http://[\\w\\.]*?placepictures\\.com(/link/[0-9a-fA-F]+(/\\d+)?)?",
        ...
        "http://([0-9a-fA-F]+(\\d+)?)\\.picturesetc\\.net/?"
