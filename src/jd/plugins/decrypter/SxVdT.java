...
@DecrypterPlugin(revision = "$Revision: 10243 $", interfaceVersion = 2, names = { "sexvideo.to" }, urls = { "http://[\\w\\.]*?sexvideo\\.to/(random|movies|clips|porn-images|dvd-r|hdtv|hentai|magazines|games)/.+" }, flags = { 0 })
