...
@DecrypterPlugin(revision = "$Revision: 12742 $", interfaceVersion = 2, names = { "4shared.com" }, urls = { "http://[\\w\\.]*?4shared(-china)?\\.com/dir/[\\w\\._-]+/[\\w\\._-]+/?" }, flags = { 0 })
        ...
        if (this.br.containsHTML("enter a password to access")) {
            ...
            for (int retry = 5; retry > 0; retry--) {
                ...
                if (!this.br.containsHTML("enter a password to access")) {
                    ...
                    if (retry == 1) {
                        Plugin.logger.severe("Wrong Password!");
