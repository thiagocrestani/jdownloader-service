...
@DecrypterPlugin(revision = "$Revision: 7387 $", interfaceVersion = 2, names = { "mp3link.org" }, urls = { "http://[\\w\\.]*?mp3link\\.org/.*?/(song|album).+" }, flags = { 0 })
public class Mp3Lnkrg extends PluginForDecrypt {
    ...
    public Mp3Lnkrg(PluginWrapper wrapper) {
        super(wrapper);
    }
