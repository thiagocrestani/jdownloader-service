...
@DecrypterPlugin(revision = "$Revision: 12825 $", interfaceVersion = 2, names = { "fotka.pl" }, urls = { "http://[\\w\\.]*?fotka\\.pl/(profil/\\w+/albumy/\\d+,\\w+(/\\d+)?|duza_fotka\\.php\\?fotka_id=\\d+\\&owner_id=\\d+)" }, flags = { 0 })
