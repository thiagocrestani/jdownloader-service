...
@HostPlugin(revision = "$Revision: 11944 $", interfaceVersion = 2, names = { "10upload.com" }, urls = { "http://[\\w\\.]*?10upload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class TenUploadCom extends PluginForHost {

    public TenUploadCom(PluginWrapper wrapper) {
        super(wrapper);
