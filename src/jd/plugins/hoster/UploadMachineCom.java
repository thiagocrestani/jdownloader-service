...
@HostPlugin(revision = "$Revision: 12366 $", interfaceVersion = 2, names = { "uploadmachine.com" }, urls = { "http://[\\w\\.]*?uploadmachine\\.com/(download\\.php\\?id=[0-9]+&type=[0-9]{1}|file/[0-9]+/)" }, flags = { 0 })
