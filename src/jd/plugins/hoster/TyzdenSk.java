 ...
 * @author typek_pb
 */
@HostPlugin(revision = "$Revision: 11804 $", interfaceVersion = 2, names = { "tyzden.sk" }, urls = { "http://[\\w\\.]*?tyzden\\.sk/(video-komentare|filmy|rozhovory-dna|rozhovory-tyzdna|reportaze-tyzdna|ankety-copy-1|ankety|rozhovory-dna-2|pripravujeme0|dokumenty-copy-1|komentare-dna)/[-0-9a-zA-Z]+.html" }, flags = { 0 })
