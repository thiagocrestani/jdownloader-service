...
@HostPlugin(revision = "$Revision: 11579 $", interfaceVersion = 2, names = { "otr.datenkeller.at" }, urls = { "http://[\\w\\.]*?otr\\.datenkeller\\.at/\\?(file|getFile)=.+" }, flags = { 0 })
public class OtrDatenkellerAt extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        link.setDownloadSize(Regex.getSize(filesize.replace("i", "")));
