...
@HostPlugin(revision = "$Revision: 10725 $", interfaceVersion = 2, names = { "filekeeper.org" }, urls = { "http://[\\w\\.]*?filekeeper\\.org/download/[0-9a-zA-Z]+/([\\(\\)0-9A-Za-z.-_% ]+|[/]+/[\\(\\)0-9A-Za-z.-_% ])" }, flags = { 0 })
