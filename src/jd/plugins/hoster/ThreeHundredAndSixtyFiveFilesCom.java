...
@HostPlugin(revision = "$Revision: 12810 $", interfaceVersion = 2, names = { "365files.com" }, urls = { "http://[\\w\\.]*?365files\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ThreeHundredAndSixtyFiveFilesCom extends PluginForHost {

    public ThreeHundredAndSixtyFiveFilesCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST   = "http://365files.com";
