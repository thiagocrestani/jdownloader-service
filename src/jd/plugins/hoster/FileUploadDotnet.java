...
@HostPlugin(revision = "$Revision: 9259 $", interfaceVersion = 2, names = { "file-upload.net" }, urls = { "((http://[\\w\\.]*?file-upload\\.net/(member/){0,1}download-\\d+/(.*?).html)|(http://[\\w\\.]*?file-upload\\.net/(view-\\d+/(.*?).html|member/view_\\d+_(.*?).html))|(http://[\\w\\.]*?file-upload\\.net/member/data3\\.php\\?user=(.*?)&name=(.*)))" }, flags = { 0 })
public class FileUploadDotnet extends PluginForHost {
     ...
     * 
     * return getVersion("$Revision: 9259 $"); }
     */
