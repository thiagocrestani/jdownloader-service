...
//This plugin gets its links from a decrypter!(ShrSwftCmFldr)
@HostPlugin(revision = "$Revision: 11444 $", interfaceVersion = 2, names = { "shareswift.com" }, urls = { "http://[\\w\\.]*?6i96j4r5ffdjho45u2ddkuiqsdftjpj8\\.com/[a-z0-9]{12}" }, flags = { 0 })
