...
@HostPlugin(revision = "$Revision: 11261 $", interfaceVersion = 2, names = { "missupload.com" }, urls = { "http://[\\w\\.]*?missupload\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class MissUploadCom extends PluginForHost {

    public MissUploadCom(PluginWrapper wrapper) {
        super(wrapper);
        enablePremium("http://turboshare.com/premium.html");
    }

    // XFilesharingpro basic Version 1.2
    @Override
    public String getAGBLink() {
        return "http://www.missupload.com/tos.html";
    }

    @Override
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        this.setBrowserExclusive();
        br.setCookie("http://www.missupload.com", "lang", "english");
    ...
    private void login(Account account) throws Exception {
        ...
        br.setCookie("http://www.missupload.com", "lang", "english");
        br.setDebug(true);
        br.getPage("http://www.missupload.com/login.html");
        Form loginform = br.getForm(0);
        if (loginform == null) throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
        loginform.put("login", Encoding.urlEncode(account.getUser()));
        loginform.put("password", Encoding.urlEncode(account.getPass()));
        br.submitForm(loginform);
        br.getPage("http://www.missupload.com/account.html");
        if (br.getCookie("http://www.missupload.com", "login") == null || br.getCookie("http://www.missupload.com", "xfss") == null) throw new PluginException(LinkStatus.ERROR_PREMIUM, PluginException.VALUE_ID_PREMIUM_DISABLE);
    }
    ...
    // In this case it's just a copy of handlefree with login added
    @Override
