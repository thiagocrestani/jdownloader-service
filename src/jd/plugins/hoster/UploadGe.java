...
@HostPlugin(revision = "$Revision: 12234 $", interfaceVersion = 2, names = { "upload.ge" }, urls = { "http://[\\w\\.]*?upload\\.ge/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })
public class UploadGe extends PluginForHost {
    ...
    // MhfScriptBasic 1.0, added new filenam/size regexes, added new ip blocked
    // text
    @Override
    ...
    public AvailableStatus requestFileInformation(DownloadLink parameter) throws Exception {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                filesize = br.getRegex("<b>File size:</b>[\n\t\r ]+</font>[\n\t\r ]+<font face=\"Verdana\" style=\"font-size: 10px\" color=\"#666666\">(.*?)</font>").getMatch(0);
            }
        }
