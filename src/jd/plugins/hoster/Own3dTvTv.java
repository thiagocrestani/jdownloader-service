...
@HostPlugin(revision = "$Revision: 12768 $", interfaceVersion = 2, names = { "own3d.tv" }, urls = { "http://[\\w\\.]*?own3d\\.tv/video/\\d+" }, flags = { 0 })
public class Own3dTvTv extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, PluginException {
        ...
        dllink = "http://vodcdn.ec.own3d.tv/" + firstPart + "?" + temporaryID;
