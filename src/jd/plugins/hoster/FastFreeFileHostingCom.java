...
@HostPlugin(revision = "$Revision: 12555 $", interfaceVersion = 2, names = { "fastfreefilehosting.com" }, urls = { "http://[\\w\\.]*?fastfreefilehosting\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })
