...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "keepfile.com" }, urls = { "http://[\\w\\.]*?keepfile\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class KeepFileCom extends PluginForHost {

    public KeepFileCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkErrors(DownloadLink theLink, boolean checkAll, String passCode) throws NumberFormatException, PluginException {
        ...
        if (brbefore.contains("You're using all download slots for IP") || brbefore.contains(">You're downloading another file at the moment.")) throw new PluginException(LinkStatus.ERROR_IP_BLOCKED, null, 10 * 60 * 1001l);
