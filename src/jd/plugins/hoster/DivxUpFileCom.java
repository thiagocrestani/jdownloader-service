...
@HostPlugin(revision = "$Revision: 12743 $", interfaceVersion = 2, names = { "divxupfile.com" }, urls = { "http://[\\w\\.]*?divxupfile\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class DivxUpFileCom extends PluginForHost {
    ...
    public void doFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        // // Ticket Time - akippable at the moment
