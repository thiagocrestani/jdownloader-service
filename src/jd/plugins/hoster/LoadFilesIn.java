...
@HostPlugin(revision = "$Revision: 12796 $", interfaceVersion = 2, names = { "loadfiles.in" }, urls = { "http://[\\w\\.]*?loadfiles\\.in/[a-z0-9]{12}" }, flags = { 2 })
public class LoadFilesIn extends PluginForHost {

    public LoadFilesIn(PluginWrapper wrapper) {
        super(wrapper);
        this.enablePremium(COOKIE_HOST + "/premium.html");
    }

    // Modified version of XfileSharingProBasic Version 1.5
    @Override
    ...
    public void doFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        if (dllink == null) {
            ...
            if (br.containsHTML(">Requested file Required More points then you have\\.")) throw new PluginException(LinkStatus.ERROR_PREMIUM, PluginException.VALUE_ID_PREMIUM_DISABLE);
    ...
    private void login(Account account) throws Exception {
        ...
        if (!br.containsHTML("Premium-Account expire") && !br.containsHTML(">Buy Points<") && !br.containsHTML(">Buy Traffic<")) throw new PluginException(LinkStatus.ERROR_PREMIUM, PluginException.VALUE_ID_PREMIUM_DISABLE);
        if (!br.containsHTML("Premium-Account expire") && !br.containsHTML(">Buy Traffic<")) nopremium = true;
    }
