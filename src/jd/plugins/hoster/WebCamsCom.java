...
@HostPlugin(revision = "$Revision: 11178 $", interfaceVersion = 2, names = { "webcams.com" }, urls = { "http://[\\w\\.]*?webcams\\.com/index\\.php\\?action=ModelPage\\&page=movie\\&model_id=\\d+\\&media_id=\\d+(\\&mmcat_id=\\d+)?" }, flags = { 0 })
