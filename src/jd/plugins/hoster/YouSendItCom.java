...
@HostPlugin(revision = "$Revision: 12421 $", interfaceVersion = 2, names = { "yousendit.com" }, urls = { "http://[\\w\\.]*?yousendit\\.com/(dl\\?phi_action=app/orchestrateDownload\\&rurl=http%253A%252F%252Fwww\\.yousendit\\.com%252Ftransfer\\.php%253Faction%253Dbatch_download%2526batch_id%253D|download/)[a-zA-Z0-9]+" }, flags = { 0 })
