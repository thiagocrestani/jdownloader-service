...
@HostPlugin(revision = "$Revision: 12603 $", interfaceVersion = 2, names = { "myvideo.de" }, urls = { "http://[\\w\\.]*?myvideo.*?/.*?/\\d+\\.flv" }, flags = { 0 })
public class MyVideo extends PluginForHost {
    ...
    // @Override
    /*
     * public String getVersion() { return getVersion("$Revision: 12603 $"); }
     */
