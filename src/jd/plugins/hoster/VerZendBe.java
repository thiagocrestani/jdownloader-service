...
@HostPlugin(revision = "$Revision: 10651 $", interfaceVersion = 2, names = { "verzend.be" }, urls = { "http://[\\w\\.]*?verzend\\.be/(en|ru|fr|es)/file/[0-9]+/" }, flags = { 0 })
public class VerZendBe extends PluginForHost {

    public VerZendBe(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    private static final String COOKIE_HOST = "http://verzend.be";
    ...
    public void handleFree(DownloadLink link) throws Exception {
        ...
        br.postPage(link.getDownloadURL(), "Free=Free+Download");
