...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "imzupload.com" }, urls = { "http://[\\w\\.]*?imzupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ImzUploadCom extends PluginForHost {

    public ImzUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://imzupload.com";
