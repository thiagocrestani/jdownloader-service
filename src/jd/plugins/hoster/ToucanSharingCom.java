...
@HostPlugin(revision = "$Revision: 12406 $", interfaceVersion = 2, names = { "toucansharing.com" }, urls = { "http://[\\w\\.]*?toucansharing\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ToucanSharingCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST = "http://toucansharing.com";
