...
@HostPlugin(revision = "$Revision: 11261 $", interfaceVersion = 2, names = { "mlfat4arab.com" }, urls = { "http://[\\w\\.]*?mlfat4arab\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class MlFat4ArabCom extends PluginForHost {

    public MlFat4ArabCom(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public String getAGBLink() {
        return "http://www.mlfat4arab.com/tos.html";
    }

    @Override
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        this.setBrowserExclusive();
        br.setCookie("http://www.mlfat4arab.com", "lang", "english");
