...
@HostPlugin(revision = "$Revision: 10161 $", interfaceVersion = 2, names = { "dump.ro" }, urls = { "http://[\\w\\.]*?dump\\.ro/[0-9A-Za-z/\\-\\.\\?\\=\\&]+" }, flags = { 0 })
public class DumpRo extends PluginForHost {
    ...
    /*
     * /* public String getVersion() { return getVersion("$Revision: 10161 $"); }
     */
