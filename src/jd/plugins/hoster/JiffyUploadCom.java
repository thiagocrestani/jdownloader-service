...
@HostPlugin(revision = "$Revision: 12669 $", interfaceVersion = 2, names = { "jiffyupload.com" }, urls = { "http://[\\w\\.]*?jiffyupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class JiffyUploadCom extends PluginForHost {

    public JiffyUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST   = "http://jiffyupload.com";
