...
@HostPlugin(revision = "$Revision: 12402 $", interfaceVersion = 2, names = { "file4save.com" }, urls = { "http://[\\w\\.]*?file4save\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class File4SaveCom extends PluginForHost {

    public File4SaveCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://file4save.com";
