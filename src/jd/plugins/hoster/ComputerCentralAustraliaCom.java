...
@HostPlugin(revision = "$Revision: 12769 $", interfaceVersion = 2, names = { "computer-central-australia.com" }, urls = { "http://[\\w\\.]*?computer-central-australia\\.com/index\\.php/files/get/[a-zA-Z0-9-_]+" }, flags = { 0 })
public class ComputerCentralAustraliaCom extends PluginForHost {

    public ComputerCentralAustraliaCom(PluginWrapper wrapper) {
        super(wrapper);
    }

    private static final String NICEHOSTESCAPED = "computer-central-australia\\.com";

    @Override
    public String getAGBLink() {
        // Hoster has no TOS/contact on the mainpage
        return "http://www.computer-central-australia.com/";
    }
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filename == null) filename = br.getRegex("\"http://www\\." + NICEHOSTESCAPED + "/index\\.php/files/gen/[a-zA-Z0-9]+/(.*?)\"").getMatch(0);
