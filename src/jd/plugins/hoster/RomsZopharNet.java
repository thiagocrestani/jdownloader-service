...
@HostPlugin(revision = "$Revision: 8967 $", interfaceVersion = 2, names = { "roms.zophar.net" }, urls = { "http://[\\w\\.]*?roms\\.zophar\\.net/download-file/[0-9]{1,}" }, flags = { 0 })
public class RomsZopharNet extends PluginForHost {
     ...
     * 
     * return getVersion("$Revision: 8967 $"); }
     */
