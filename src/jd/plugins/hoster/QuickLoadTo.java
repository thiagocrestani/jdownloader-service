...
@HostPlugin(revision = "$Revision: 12703 $", interfaceVersion = 2, names = { "quickload.to" }, urls = { "http://[\\w\\.]*?quickload\\.to/\\?Go=Player\\&HashID=FILE[A-Z0-9]+" }, flags = { 0 })
public class QuickLoadTo extends PluginForHost {

    public QuickLoadTo(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public String getAGBLink() {
        return "http://quickload.to/?Go=Home";
    }
