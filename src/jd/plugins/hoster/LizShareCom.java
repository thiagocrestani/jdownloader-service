...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "lizshare.net" }, urls = { "http://[\\w\\.]*?lizshare\\.net/[a-z0-9]{12}" }, flags = { 0 })
public class LizShareCom extends PluginForHost {

    public LizShareCom(PluginWrapper wrapper) {
        super(wrapper);
