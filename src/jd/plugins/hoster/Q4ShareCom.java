...
@HostPlugin(revision = "$Revision: 11550 $", interfaceVersion = 2, names = { "q4share.com" }, urls = { "http://[\\w\\.]*?q4share\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class Q4ShareCom extends PluginForHost {
