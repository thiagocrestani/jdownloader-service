...
@HostPlugin(revision = "$Revision: 12271 $", interfaceVersion = 2, names = { "6ybh-upload.com" }, urls = { "http://[\\w\\.]*?6ybh-upload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class SixYbhUploadCom extends PluginForHost {

    public SixYbhUploadCom(PluginWrapper wrapper) {
        super(wrapper);
