...
@HostPlugin(revision = "$Revision: 11635 $", interfaceVersion = 2, names = { "appscene.org" }, urls = { "http://[\\w\\.]*?(appscene\\.org|filedude\\.com)/(download/[0-9a-zA-Z]+|download\\.php\\?id=\\d+)" }, flags = { 2 })
