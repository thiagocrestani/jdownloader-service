...
@HostPlugin(revision = "$Revision: 12817 $", interfaceVersion = 2, names = { "filetube.to" }, urls = { "http://[\\w\\.]*?filetube\\.to/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })
public class FileTubeTo extends PluginForHost {

    public FileTubeTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://filetube.to";
