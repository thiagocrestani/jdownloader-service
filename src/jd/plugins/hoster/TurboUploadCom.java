...
@HostPlugin(revision = "$Revision: 12678 $", interfaceVersion = 2, names = { "turboupload.com" }, urls = { "http://[\\w\\.]*?turboupload\\.com/[a-z0-9]+" }, flags = { 0 })
public class TurboUploadCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://turboupload.com";
