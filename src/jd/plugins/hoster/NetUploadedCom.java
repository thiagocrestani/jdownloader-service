...
@HostPlugin(revision = "$Revision: 12782 $", interfaceVersion = 2, names = { "netuploaded.com" }, urls = { "http://[\\w\\.]*?netuploaded\\.com/[a-z0-9]{12}" }, flags = { 2 })
public class NetUploadedCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST   = "http://netuploaded.com";
