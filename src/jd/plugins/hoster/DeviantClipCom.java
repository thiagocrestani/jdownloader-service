...
@HostPlugin(revision = "$Revision: 10757 $", interfaceVersion = 2, names = { "deviantclip.com" }, urls = { "http://[\\w\\.]*?gsghe366REHrtzegiolp/Media-([0-9]+-[0-9]+_|[0-9]+_).*?\\.html(---picture|---video)" }, flags = { 0 })
