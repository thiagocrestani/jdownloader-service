...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "flowhot.info" }, urls = { "http://[\\w\\.]*?flowhot\\.info/[a-z0-9]{12}" }, flags = { 0 })
public class FlowHotInfo extends PluginForHost {
