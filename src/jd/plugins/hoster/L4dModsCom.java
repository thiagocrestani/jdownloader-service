...
@HostPlugin(revision = "$Revision: 11385 $", interfaceVersion = 2, names = { "l4dmods.com" }, urls = { "http://[\\w\\.]*?l4dmods\\.com/index\\.php\\?option=com_joomloads(2)?\\&(view=package|controller=package&task=download)\\&(Itemid=[0-9]\\&packageId=[0-9]+|pid=\\d+\\&Itemid=\\d+)" }, flags = { 2 })
