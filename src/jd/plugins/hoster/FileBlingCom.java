...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "filebling.com" }, urls = { "http://[\\w\\.]*?filebling\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileBlingCom extends PluginForHost {
    ...
    private static final String COOKIE_HOST = "http://filebling.com";
