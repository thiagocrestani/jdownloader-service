...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "filevo.com" }, urls = { "http://[\\w\\.]*?filevo\\.com/[a-z0-9]{12}\\.html" }, flags = { 2 })
public class FileVoCom extends PluginForHost {

    public FileVoCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://filevo.com";
    ...
    public void doFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        // // Ticket Time (not needed, at the moment they don't check is
        // serverside)
