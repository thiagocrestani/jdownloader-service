...
@HostPlugin(revision = "$Revision: 11590 $", interfaceVersion = 2, names = { "movreel.com" }, urls = { "http://[\\w\\.]*?movreel\\.com/(video/)?[a-z0-9]{12}" }, flags = { 0 })
public class MovReelCom extends PluginForHost {
    ...
    // XfileSharingProBasic Version 1.6, modified dllink regexes
    @Override
    ...
    private static final String COOKIE_HOST = "http://movreel.com.com";
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (br.containsHTML("(No such file|No such user exist|File not found|The file was removed by )")) {
