...
@HostPlugin(revision = "$Revision: 12889 $", interfaceVersion = 2, names = { "fileplanet.com.ua" }, urls = { "http://[\\w\\.]*?fileplanet\\.com\\.ua/[a-z0-9]{12}" }, flags = { 0 })
public class FilePlanetComUa extends PluginForHost {

    public FilePlanetComUa(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/premium.html");
    }

    // XfileSharingProBasic Version 1.6, modified filesize regex
    @Override
