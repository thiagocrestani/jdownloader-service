...
@HostPlugin(revision = "$Revision: 12234 $", interfaceVersion = 2, names = { "up.jeje.ge" }, urls = { "http://[\\w\\.]*?up\\.jeje\\.ge//((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es)/)?file/[0-9]+/)" }, flags = { 0 })
