...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "filestock.ru" }, urls = { "http://[\\w\\.]*?filestock\\.ru/[a-z0-9]{12}" }, flags = { 0 })
public class FileStockRu extends PluginForHost {

    public FileStockRu(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    private static final String COOKIE_HOST = "http://www.filestock.ru";
