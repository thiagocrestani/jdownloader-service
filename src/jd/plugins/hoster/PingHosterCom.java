...
@HostPlugin(revision = "$Revision: 11261 $", interfaceVersion = 2, names = { "pinghoster.com" }, urls = { "http://[\\w\\.]*?pinghoster\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class PingHosterCom extends PluginForHost {

    public PingHosterCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://pinghoster.com";
