...
@HostPlugin(revision = "$Revision: 12366 $", interfaceVersion = 2, names = { "fisierulmeu.ro" }, urls = { "http://[\\w\\.]*?fisierulmeu\\.ro/.+/.+\\.html" }, flags = { 0 })
public class FisierulMeuRo extends PluginForHost {
    ...
    // @Override
    /*
     * /* public String getVersion() { return getVersion("$Revision: 12366 $");
     * }
     */
