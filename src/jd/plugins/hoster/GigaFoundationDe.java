...
@HostPlugin(revision = "$Revision: 12257 $", interfaceVersion = 2, names = { "gigafoundation.de" }, urls = { "http://[\\w\\.]*?gigafoundationdecrypted\\.de/features/downloads/details/\\d+" }, flags = { 2 })
