...
@HostPlugin(revision = "$Revision: 11261 $", interfaceVersion = 2, names = { "useupload.com" }, urls = { "http://[\\w\\.]*?useupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class UseUploadCom extends PluginForHost {

    public UseUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://useupload.com";
