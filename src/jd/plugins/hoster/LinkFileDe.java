 ...
 */
@HostPlugin(revision = "$Revision: 11602 $", interfaceVersion = 2, names = { "linkfile.de" }, urls = { "http://[\\w\\.]*?linkfile.de/download-[\\w]+\\.php" }, flags = { 0 })
public class LinkFileDe extends PluginForHost {
    ...
    /*
     * public String getVersion() { return getVersion("$Revision: 11602 $"); }
     */
