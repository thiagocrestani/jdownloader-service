...
@HostPlugin(revision = "$Revision: 9411 $", interfaceVersion = 2, names = { "nahraj.cz" }, urls = { "http://[\\w\\.]*?nahraj\\.cz/content/(view|download)/[a-z|0-9]+-[a-z|0-9]+-[a-z|0-9]+-[a-z|0-9]+-[a-z|0-9]+" }, flags = { 0 })
