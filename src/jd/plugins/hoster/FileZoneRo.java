...
@HostPlugin(revision = "$Revision: 9411 $", interfaceVersion = 2, names = { "filezone.ro" }, urls = { "http://[\\w\\.]*?filezone\\.ro/(files/[0-9a-z_]+/[0-9a-zA-Z_.]+|public.php\\?action=viewfile&file_id=\\d+|public/viewset/\\d+)" }, flags = { 0 })
