...
@HostPlugin(revision = "$Revision: 12694 $", interfaceVersion = 2, names = { "hoster.to" }, urls = { "http://[\\w\\.]*?hoster\\.to/[a-z0-9]{12}" }, flags = { 0 })
public class HosterTo extends PluginForHost {

    public HosterTo(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/premium.html");
    }

    // XfileSharingProBasic Version 1.9.4, special filename and filesize regexes
    @Override
    ...
    private static final String COOKIE_HOST   = "http://hoster.to";
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
                ...
                if (filename == null) {
                    ...
                    if (filename == null) {
                        ...
                        if (filename == null) {
                            ...
                            if (filename == null) {
                                filename = new Regex(BRBEFORE, "<b>Filename:</b></td>[\t\n\r ]+<td valign=\"middle\">(.*?)</td>").getMatch(0);
                            }
                        }
                    }
                }
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) {
                    filesize = new Regex(BRBEFORE, "<b>Size:</b></td><td>(.*?)\\&nbsp; <small>").getMatch(0);
                }
            }
        }
