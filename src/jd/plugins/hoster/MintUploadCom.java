...
@HostPlugin(revision = "$Revision: 12226 $", interfaceVersion = 2, names = { "mintupload.com" }, urls = { "http://[\\w\\.]*?mintupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class MintUploadCom extends PluginForHost {

    public MintUploadCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/premium.html");
    }

    // XfileSharingProBasic Version 1.8, added new file not found texts
    @Override
    ...
    private static final String COOKIE_HOST = "http://mintupload.com";
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        doSomething();
        if (brbefore.contains("No such file") || brbefore.contains("No such user exist") || brbefore.contains("File not found") || brbefore.contains(">File Not Found<") || brbefore.contains("The file was removed by") || brbefore.contains("Reason of deletion: ")) {
