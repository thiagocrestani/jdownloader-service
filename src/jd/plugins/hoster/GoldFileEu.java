...
@HostPlugin(revision = "$Revision: 12957 $", interfaceVersion = 2, names = { "goldfile.eu" }, urls = { "http://(www\\.)?goldfile\\.eu/[a-z0-9]{12}" }, flags = { 0 })
public class GoldFileEu extends PluginForHost {

    public GoldFileEu(PluginWrapper wrapper) {
        super(wrapper);
