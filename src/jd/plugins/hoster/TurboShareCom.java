...
@HostPlugin(revision = "$Revision: 12571 $", interfaceVersion = 2, names = { "turboshare.com" }, urls = { "http://[\\w\\.]*?turboshare\\.com/files/[0-9]+/.+" }, flags = { 2 })
public class TurboShareCom extends PluginForHost {
    ...
    public void handleFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        // Their site shows wrong MD5 hashes so we don't set it in JD
        // String md5hash =
        // br.getRegex("<b>MD5.*?</b>.*?nowrap>([a-z0-9]+)<").getMatch(0);
        // if (md5hash != null) {
