...
@HostPlugin(revision = "$Revision: 10566 $", interfaceVersion = 2, names = { "bitroad.net" }, urls = { "http://[\\w\\.]*?(bitroad\\.net|filemashine\\.com|friendlyfiles\\.net|vip4sms\\.com|manuls\\.ru)/download/[A-Fa-f0-9]+" }, flags = { 0 })
