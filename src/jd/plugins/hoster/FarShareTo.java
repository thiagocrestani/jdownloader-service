...
@HostPlugin(revision = "$Revision: 12916 $", interfaceVersion = 2, names = { "farshare.to" }, urls = { "http://(www\\.)?farshare\\.to/[a-z0-9]{12}" }, flags = { 0 })
public class FarShareTo extends PluginForHost {

    public FarShareTo(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST   = "http://farshare.to";
