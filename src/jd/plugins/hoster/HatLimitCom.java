...
@HostPlugin(revision = "$Revision: 12369 $", interfaceVersion = 2, names = { "hatlimit.com" }, urls = { "http://[\\w\\.]*?hatlimit\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class HatLimitCom extends PluginForHost {

    public HatLimitCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/premium.html");
        this.setStartIntervall(65 * 1000l);
    }

    // XfileSharingProBasic Version 1.8, added 1 filesize regex, modified
    ...
    private static final String COOKIE_HOST = "http://hatlimit.com";
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) {
                    filesize = new Regex(brbefore, "Download File .*? <b>\\((.*?)\\)</b><br>").getMatch(0);
                }
            }
        }
    ...
    public void doFree(DownloadLink downloadLink) throws Exception, PluginException {
        ...
        } else if (brbefore.contains("api.recaptcha.net") || brbefore.contains("/recaptcha/api/challenge")) {
