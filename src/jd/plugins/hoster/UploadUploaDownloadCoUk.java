...
@HostPlugin(revision = "$Revision: 11694 $", interfaceVersion = 2, names = { "upload.uploadownload.co.uk" }, urls = { "http://[\\w\\.]*?upload\\.uploadownload\\.co\\.uk/[a-z0-9]{12}" }, flags = { 0 })
public class UploadUploaDownloadCoUk extends PluginForHost {

    public UploadUploaDownloadCoUk(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private static final String COOKIE_HOST = "http://upload.uploadownload.co.uk";
