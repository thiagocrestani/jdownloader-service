...
@HostPlugin(revision = "$Revision: 12865 $", interfaceVersion = 2, names = { "filesmonster.com" }, urls = { "http://[\\w\\.\\d]*?(filesmonsterdecrypted\\.com/download.php\\?id=|filesmonster(decrypted)?\\.com/dl/.*?/free/(2|1)/).+" }, flags = { 2 })
