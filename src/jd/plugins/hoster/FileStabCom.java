...
@HostPlugin(revision = "$Revision: 12806 $", interfaceVersion = 2, names = { "filestab.com" }, urls = { "http://[\\w\\.]*?filestab\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class FileStabCom extends PluginForHost {

    public FileStabCom(PluginWrapper wrapper) {
        super(wrapper);
        // this.enablePremium(COOKIE_HOST + "/premium.html");
    }

    // XfileSharingProBasic Version 1.8, added 1 filesize regex
    @Override
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filesize == null) {
            ...
            if (filesize == null) {
                ...
                if (filesize == null) filesize = new Regex(brbefore, ">File Size : </span><span class=\"file_code\">(.*?)</span>").getMatch(0);
            }
        }
