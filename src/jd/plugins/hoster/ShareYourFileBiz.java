...
@HostPlugin(revision = "$Revision: 11261 $", interfaceVersion = 2, names = { "shareyourfile.biz" }, urls = { "http://[\\w\\.]*?shareyourfile\\.biz/[a-z0-9]{12}" }, flags = { 0 })
public class ShareYourFileBiz extends PluginForHost {

    public ShareYourFileBiz(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    private static final String COOKIE_HOST = "http://shareyourfile.biz/";
