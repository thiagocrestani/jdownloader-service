...
@OptionalPlugin(rev = "$Revision: 12612 $", id = "lecturnity", interfaceversion = 7)
public class LecturnityDownloader extends PluginOptional {
    ...
    public boolean initAddon() {
        hpw = new HostPluginWrapper("lecturnity-loader", "jd.plugins.optional.lecturnity.", "LecturnityLoader", "HIDE_ME", 0, "$Revision: 12612 $");
